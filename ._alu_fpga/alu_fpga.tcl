...
if ([project_exists alu_fpga]) {
  project_open -revision alu_fpga alu_fpga
} else {
  project_new -revision alu_fpga alu_fpga
}
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY /home/ecegridfs/a/437mg005/ece437/processors/._alu_fpga
...
set_global_assignment -name SDC_FILE alu_fpga.sdc
...
set_global_assignment -name SYSTEMVERILOG_FILE /home/ecegridfs/a/437mg005/ece437/processors/source/alu_fpga.sv
